...
public class Replacements {
    ...
    public static void init() {
        ...
        H.addReplace("minecraft", "cat", () -> () -> H.lambdaReplace(EntityType.CAT, 0.5F, r -> r
                ...
                .tMappedRaw(e -> catTextures.computeIfAbsent(e.getCatVariant().texture().getPath(), s -> new ResourceLocation(BetterAnimalModels.MODID, s)))
